    ...
    <AnimatedPage>
      <div className="flex flex-col items-center justify-start px-4 py-16 space-y-12">
        ...
        <p className="max-w-2xl text-center text-gray-300">
          Esta é a página About. Aqui você pode colocar uma descrição da empresa,
          projeto ou portfólio.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-4xl">
          {/* Cards com imagens aleatórias */}
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-gray-400 mt-2">
                  Descrição do card {i + 1}. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
              </div>
            </div>
          ))}
